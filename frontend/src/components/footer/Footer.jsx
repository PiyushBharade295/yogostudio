       ...
       <footer aria-label="Site Footer" className="bg-white dark:bg-black">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    ...
                    >
                        <div>
                            <strong className="font-bold dark:text-white text-gray-900">  </strong>
                        ...
                        <div>
                            <strong className=" dark:text-white font-bold text-gray-900">  </strong>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    <p className="text-center text-xs/relaxed text-gray-500">
                        ...
                        Created by &nbsp;
                        <a className="text-secondary dark: underline transition hover:text-secondary dark:/75">Pallavi Ambhore</a>
                    </p>
                </div>
            </div>
        </footer>
