            ...
            <div className="grid grid-cols-12 md:gap-[30px]">
              <div className="lg:col-span-8 col-span-12">
                <div className="single-course-details">
                  ...
                  <h2 className="text-2xl mb-2">Exercise hacks for women</h2>
                    ...
                    <div id="tabs-content ">
                      <div id="tab1" className="tab-content">
                        <div>
                          ...
                          <p className="mt-4">
                            Embark on a journey of self-discovery and physical well-being with our comprehensive yoga tutorial. Whether you're a beginner seeking relaxation or an experienced practitioner looking to deepen your practice, this tutorial offers something for everyone.
                            <br /> <br /> In this tutorial, you will:

Learn the Basics: Master foundational poses (asanas) with step-by-step instructions and proper alignment tips.
Explore Breathwork: Understand the importance of pranayama (breathing techniques) to enhance relaxation and focus.
Cultivate Mindfulness: Incorporate meditation and mindfulness practices to promote mental clarity and reduce stress.
Personalize Your Practice: Tailor sessions to your needs with modifications and variations suitable for all levels.
Achieve Balance: Blend strength, flexibility, and relaxation to create harmony in body and mind
                          </p>
